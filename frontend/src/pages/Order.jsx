...
<h2 className='text-2xl font-semibold mb-4'>Thank you fo your Order</h2>
<p>Your Order has been placed successfully you will recieve an email confirmation shortly</p>
<div className='mt-6 p-4 border rounded-lg gb-gray-100'>
    ...
    <div className='mt-6'>
      ...
      onClick={() => navigate ("/n")}>Continue Shopping</button>
    </div>
</div>
    </div>
  )
